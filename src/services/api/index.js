...
export const BACKENDS = {
  CL_TECH: {
    baseURL: import.meta.env.VITE_CL_TECH_API_URL,
    socketURL: import.meta.env.VITE_CL_TECH_SOCKET_URL,
    name: 'CL Tech',
    color: 'purple'
  },
  AUTOTASK: {
    baseURL: import.meta.env.VITE_AUTOTASK_API_URL,
    socketURL: import.meta.env.VITE_AUTOTASK_SOCKET_URL,
    name: 'AutoTask',
    color: 'blue'
  }
}
